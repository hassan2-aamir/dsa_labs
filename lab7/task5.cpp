...
// Function to delete all leaf nodes in the binary search tree
void deleteLeafs(BST_Node* root, binarySearchTree &bst) {
    ...
    if(root->LeftChild == nullptr && root->RightChild == nullptr) {
        ...
        deleteLeafs(root->LeftChild, bst);
        deleteLeafs(root->RightChild, bst);
    }
}
...
int main() {
    ...
    InOrderTraversal(bst.root);   // Print tree contents before deleting leaf nodes

    // Delete all leaf nodes in the binary search tree
    deleteLeafs(bst.root, bst);
    
    // Display the tree contents after deleting leaf nodes
    cout << endl << "Tree Contents after deleting leafs: " << endl;
